...
public enum Enemies {
    SKELETON_ARCHER(new Enemy("Skeleton Archer", 10, 10, 5, 20, 20, 10, 10, 0, new HashMap<>(), Class.Archer, player.getLvl(), 6, 10)),
    SKELETON_WARRIOR(new Enemy("Skeleton Warrior", 20, 20, 2, 20, 20, 10, 10, 0, new HashMap<>(), Class.Archer, player.getLvl(), 7, 10)),
